...
const Product = ({ products, loading, productFetching }) => {
  ...
  const slicedData = products?.slice(firstPostIndex2, lastPostIndex2);
  ...
  return slicedData?.length > 0 ? (
    loading ? (
      ...
      <>
        ...
        <div className="switch_btn">
          <button className="active" onClick={() => setCurrentPage2(currentPage2 + 1)}>
            View More
          </button>
        </div>
      </>
    ...
    <>
    {
      products?.length >0 && slicedData?Link.length
    }
         <div className="switch_btn">
          <button className="active" onClick={() => setCurrentPage2(currentPage2 - 1)}>
            View Less
