        ...
        <div className="HomePage">
          <div className="Container">
            ...
            <div className="switch_btn">
              <button className={query === "NewArrival" ? "active" : ""} onChange={() => setQuery("NewArrival") } >
                New Arrivals
              </button>
              <button className={query === "BestSeller" ? "active" : ""} onChange={() => setQuery("BestSeller") }>
                Bestseller
              </button>
              <button className={query === "getOnSale" ? "active" : ""} onChange={() => setQuery("NewArrival") }>
                On Sale
              </button>
            </div>
