...
import { ContactDetail, createQuery } from "../../Repository/User/ContactDetail";
...
const Contact = () => {
  ...
  const [query , setMobile ] = useState(null)
  // createQuery()
            ...
            <div className="Content">
              ...
              <div className="social-links">
                <ul>
                  ...
                  <li>
                    <a  href={`https://${contactDetail?.dribbble}`} target="_blank">
