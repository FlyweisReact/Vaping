...
import { getRelatedProduct, getSingleProducts } from "../../Repository/User/Product";
...
const SpecificProduct = () => {
  ...
  const allRelatedProduct = async () => {
    try {
      const res = await getRelatedProduct(catId);
      setProduct(res);
      getImageLink(res);
      setCatId(res?.categoryId?._id)
    } catch {}
