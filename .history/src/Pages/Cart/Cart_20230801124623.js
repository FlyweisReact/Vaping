...
const Cart = () => {
  ...
  const options = {
    clientSecret:
      "pk_test_51NYnaISGUdCg6ljtoAiKIBOUFoZePxplk65z8FjHXyvWx3bSfRWxYMd1vv5Qh2AYweuolrIqxwLX6XmsZ41ueyAC00MBUskGaO", // Replace this with the actual client_secret from the server
  };
