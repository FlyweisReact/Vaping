...
const Cart = () => {
  ...
  const options = {
    clientSecret:
      "sk_test_51NYnaISGUdCg6ljtluiIkzYmQQrVrajA9VCEK8wZDsMhQyosbjhJxrOYbGgHAInisiRdvQbdXjuLE7VrbvbiAnkY00GnxAIl5s", // Replace this with the actual client_secret from the server
  };
