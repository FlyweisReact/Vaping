...
const getRelatedProduct = async (id) => {
  try{
    const response = await axios.get(`${BaseUrl}api/v1/Product/all/paginateProductSearch?categoryId=64be3ea62591b241463b2528`);
    return response.data.data;
  }catch(e) { 
    console.log(e)
  }
...
export { FilterProducts ,getSingleProducts };
